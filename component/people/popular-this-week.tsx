    ...
    <div className="lg:col-span-3">
      ...
      <div className="flex flex-col">
        {POPULAR_MEMBERS.map((member) => (
          <div key={member.id} className="flex items-center justify-between py-3 border-b border-outline-variant/30 hover:bg-surface-container-low transition-colors px-2 group">
            <div className="flex items-center gap-4">
              {member.avatar ? (
                ...
                <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-on-primary font-bold text-lg border border-outline-variant/50 group-hover:border-primary/50 transition-colors shadow-sm">
                  {member.avatarText}
                </div>
              )}
              <div>
                <h4 className="font-label-md text-base text-on-surface font-bold hover:text-primary cursor-pointer transition-colors">{member.name}</h4>
            ...
            <div className="flex items-center gap-4 md:gap-8">
              ...
              <button className="bg-surface-container-high text-on-surface rounded-full w-8 h-8 flex items-center justify-center hover:bg-primary hover:text-on-primary-container transition-colors ml-2 shadow-sm">
